    ...
    <div className='ranked-simulator-container'>
      ...
      <div className="ranked-cards-section">
        ...
        <div className="exam-start-card">
            <p> <Hourglass size={15}/> পরীক্ষার ধরন নির্ধারণ করুন</p>
            <div className="divider"></div>
            <p>পরীক্ষার ব্যাপ্তি</p>
            <div className="selection-card-container">
                <div className="selection-card c1">
            ...
            <div className="selection-card">
                    ...
                    <p>পরীক্ষা শুরু হলে নির্ধারিত সময়ের মধ্যে সব উত্তর প্রদান করতে হবে। সময় শেষ হলে স্বয়ংক্রিয়ভাবে উত্তরপত্র জমা হয়ে যাবে।</p>
            </div>
            <button onClick={props.handleStartRank} className='start-button'>পরীক্ষায় অংশ নিন</button>
        </div>
        <div className="leaderboard-card">
            <p> <Users size={15}/> গ্লোবাল লিডারবোর্ড</p>
